...
/**
 * Casca do checkout: mostra o cabeçalho de coleta ("Falta um passo…"), o link "Entrar" do topo
 * e o resumo do plano SÓ durante a escolha do método. Ao entrar num estado terminal (pagamento
 * criado, teste iniciado, sucesso, recusa, análise), esconde os três — o estado terminal fala
 * por si, tem o seu próprio link de "entrar", e o cabeçalho otimista contradiria o resultado.
 */
